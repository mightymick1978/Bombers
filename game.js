...
window.startGame = function() {
  ...
  updateUI();
  showMessage("Spiel gestartet! Du bist am Zug. Wähle eine Kategorie.");
};
...
function playRound(playerCard, category) {
  ...
  setTimeout(() => {
    ...
    if (playerValue > computerValue) {
      ...
      showMessage(`Unentschieden! Karten bleiben liegen.`);
      currentPlayer = 'player';
    }
